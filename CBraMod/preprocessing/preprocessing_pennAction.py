...
This version is intended for the first PennAction experiment with MOMENT's
default temporal reduction. Raw samples remain [13, 2, L]; MOMENT embedding
generation can flatten them into 26 univariate series and reduce each series
to one 1024-dimensional representation.
...
def write_lmdb(
    ...
    try:
        ...
        dataset_meta = {
            ...
            "flattened_series_count_for_moment": (
                N_JOINTS * N_COORDS
            ),
            "moment_reduction_target_shape_per_window": (
                N_JOINTS * N_COORDS,
                1024,
            ),
            "normalization": (
