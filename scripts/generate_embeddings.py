from stamp.datasets import lmdb_pickle_dataset, lmdb_np_dataset
...
if __name__ == '__main__':
    ...
    # embedding_model_name = "chronos-t5-large"
    # model_load_fn = load_chronos_model
    # model_dir = local_config.chronos_models_dir
    # embedding_agg = "mean"   # or "eos"

    tmp_dir = 'temporary' # Temporary directory to store intermediate chunk files
    dataset_name = 'sere_event_comp'
